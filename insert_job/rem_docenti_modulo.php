				...
				?>
		  <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Rimuovi docente da un modulo</h1>
                   		
							<form id="select_form" class="user" action="insert_job/RemDocente.php" method="post" onSubmit="return validate();">	
	...
	$(document).ready(function(){
		...
		$("select#docenteid").change(function(){
			...
			$.post("business/select-DocMod.php", {id_anagrafica:id_doc}, function(data){
