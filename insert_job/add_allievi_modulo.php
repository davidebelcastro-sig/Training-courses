    <!-- Begin Page Content -->
				...
				?>
		  <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Assegna allievo ad un modulo</h1>
                   		
							<form id="select_form" class="user" action="insert_job/AssegnaAllievo.php" method="post" onSubmit="return validate();">	
							
								 <div class="row">
                                    <div class="col-sm-12">
                                   <label style="width:20%;">Allievo*</label><select name = "allievoid" id= "allievoid" style="width:80%;" required><option value="">Seleziona allievo</option>
										<?php 							
